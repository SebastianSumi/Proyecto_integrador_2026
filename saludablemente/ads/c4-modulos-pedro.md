...
> El PDF de esquema expresa un modelo lógico con sintaxis MySQL/MariaDB. La persistencia física local vigente está en `database/oracle/local/`; los cambios Oracle controlados están en `database/oracle/manual-migrations/`.
