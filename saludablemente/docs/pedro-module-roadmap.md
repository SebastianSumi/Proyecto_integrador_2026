...
TEAM-IDENTITY-05A agregó `database/oracle/migrations/team_identity_05/00_preflight.sql` y su runbook. Su ejecución devolvió NO-GO al encontrar exactamente una fila en `SAL_TEAMS.TEAMS`; no ejecutó DDL y no alcanzó el inventario posterior de dependencias/grants.
